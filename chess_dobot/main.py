...
def reset_party():
    ...
    if codes != []:
        new_party(codes[0]["code"], codes[0]["skill_level"])
    ...
    if request.method == "GET":
        ...
        if new_code in codes:
            ...
            if codes == []:
                ...
                codes.append({"code" : new_code, "skill_level" : skill_level})

                return Response(len(codes), status=201, mimetype="text/html")
    else:
